$(function () {
    ...
    $(".formMoney").maskMoney({ thousands: "" }); //MaskMoney formata Moeda R$

    $('[data-tip="tooltip"]').tooltip(); // Aplica tooltip nos titles

    $(".select").select2({ width: '100%' }); // Aplica select2 nos combobox
